...
Introducing Conditional Access as Code. A fully automated solution to kickstart and maintain your Conditional Access deployment. The solution consists of three main components.
